...
class _CesiumEntity(_CesiumObject):
    ...
    horizontal_origin = traitlets.Instance(klass = constants.HorizontalOrigin, allow_none = True)
    vertical_origin = traitlets.Instance(klass = constants.VerticalOrigin, allow_none = True)
    ...
    availability = traitlets.Instance(klass = time.TimeIntervalCollection, allow_none = True)
    ...
    def __init__(
        ...
        self.pixel_offset_scale_by_distance = com.notimplemented(pixel_offset_scale_by_distance)
    ...
    def copy(self):
        kwds = {}
        for key in self._props + self._common_props + ['name', 'position', 'orientation',]:
