...
class PlottingAccessor(object):
    ...
    def bar(self, x, y, z, size=10e3, color=None, bottom=0.0):
        """
        ...
        bottom = self._fill_by(bottom, len(x), key="bottom", default=0.0)
    ...
    def pin(self, x, y, z=None, text=None, size=None, color=None):
        ...
        for i, (_text, _x, _y, _z, _size, _color) in enumerate(
