...
class TestShapelyCartesian:
    ...
    def test_line_to_cartesian_array(self):
        ...
        exp = cartesian.Cartesian3.fromDegreesArray([0.0, 1.0, 2.0, 3.0])
        ...
        exp = cartesian.Cartesian3.fromDegreesArray(
            [0.0, 1.0, 2.0, 3.0, 1.0, 3.0, 0.0, 1.0]
        )
        self.assertIsInstance(res, cartesian.Cartesian3Array)
        self.assertEqual(res.script, exp.script)
...
class TestShapelyEntity:
    ...
    def test_line_to_entity(self):
        ...
        exp = [
            "{polyline : {positions : Cesium.Cartesian3.fromDegreesArray([1.0, 1.0, 1.0, 2.0])}}",
    ...
    def test_polygon_to_entity(self):
        ...
        exp = [
            "{polygon : {hierarchy : Cesium.Cartesian3.fromDegreesArray([1.0, 1.0, 1.0, 2.0, 2.0, 2.0, 2.0, 1.0, 1.0, 1.0])}}",
